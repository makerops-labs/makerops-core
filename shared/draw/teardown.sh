#!/bin/bash
# Tears down the draw.io stack completely.
# Removes all containers, volumes, images, and networks created by this service.
#
# draw.io is stateless — there are no persistent data volumes to lose.
...
echo ""
echo "Done. Run ./start.sh to create a fresh installation."
