...
echo "  http://openwebui.localhost    → port ${OPENWEBUI_PORT:-8080}"
echo "  http://agents.localhost       → port ${SMOLAGENTS_PORT:-8090}"
echo "  http://wg.localhost           → port ${WG_PORT:-8820}"
echo "  http://draw.localhost         → port ${DRAW_PORT:-8085}"
echo ""
